...
# Таблицы основаны на действующих ставках 2025 года и применяются
# только к автомобилям старше 3 лет
FL_STP_3_5 = [
...
# Для авто до 3 лет применяется адвалор 15% (см. calculate_company)
